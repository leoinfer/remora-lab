...
| R4X width sweep | `HISTORICAL_RECONSTRUCTION_AVAILABLE` | [`historical_command.sh`](research/archival/r4x/width-sweep/historical_command.sh) | [`repro/r4x/width-sweep/`](repro/r4x/width-sweep/) | [`sanitized_receipt.json`](repro/r4x/width-sweep/sanitized_receipt.json) | Kernel/prefill diagnostic rows/s, not generation tokens/s |
